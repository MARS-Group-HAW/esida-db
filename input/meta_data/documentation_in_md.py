...
Reads a meta file in form of a csv file and transform the information into markdown file for each parameter
"""
...
def check_for_match():
    #checks if both list have identical entry. Raises Error if not else returns the list of abbreviations
...
def documentation (abbrev, i):
    #reads information from the description in the meta dataframe, transforms it into a markdown string

    ...
    def load(self, shapes=None, save_output=False):
        ...
        for name, shape_id in name_to_id.items():
            ...
            dfx = df[df['HEALTH WORKERS'].isin([
                'DENSITY OF DOCTORS AND  ASSISTANT MEDICAL OFFICER (AMO) PER 10 000 PEOPLE',
                'DENSITY OF MEDICAL OFFICERS (MOS) AND ASSISTANT MEDICAL OFFICERS (AMOS) PER 10000 POPULATION'
            ])]
